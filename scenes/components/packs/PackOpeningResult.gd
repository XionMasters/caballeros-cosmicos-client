...
func show_cards(pack_name: String, cards: Array):
	...
	for card_json in cards:
		...
		# Conectar señal de clic para mostrar detalle
		...
		# Cargar imagen usando CardsManager (con caché)
		# Conectar la señal directamente al método del card_display
		if card.image_url != "":
...
func _load_card_image_for_display(card_id: String, image_url: String, display: Control):
	"""Carga la imagen para un display específico, evitando capturar referencias en lambdas"""
	...
	# Crear una función con weak reference
...
func animate_entrance():
	"""Animación de entrada de las cartas"""
	modulate.a = 0
...
func animate_cards_reveal():
	"""Anima la aparición de cada carta"""
	var delay = 0.0
...
func _on_card_clicked(card: CardData):
	...
	var texture = null
	# Intentar obtener la textura del caché
